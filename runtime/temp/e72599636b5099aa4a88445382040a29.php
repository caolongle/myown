<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"E:\phpstudy\PHPTutorial\WWW\crm_gk\public/../application/scxfx_gk\view\user\role_list.html";i:1516862332;s:47:"../application/scxfx_gk/view/common/header.html";i:1517382407;s:45:"../application/scxfx_gk/view/common/body.html";i:1517383856;s:49:"../application/scxfx_gk/view/common/resource.html";i:1517194925;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	    <meta charset="utf-8" />
						...
						<div class="row">
										...
										<tbody>
											<?php if(is_array($role) || $role instanceof \think\Collection || $role instanceof \think\Paginator): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
												<tr>
													...
													<td>
														<span class="label label-success arrowed arrowed-right"><?php echo $val['r_name']; ?></span>
													</td>

													<td class="hidden-480"><?php echo $val['p_name']; ?></td>

													<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">

															<a class="blue iframe pull-in" value="/scxfx_gk/user/edit_role/id/<?php echo $val['id']; ?>" style="cursor: pointer" cate="1">
																<i class="icon-pencil bigger-130"></i>
																编辑
															</a>
															&nbsp;
															<?php if($val['id'] != 1): ?>
															<a class="red pull-in"  onclick="del(<?php echo $val['id']; ?>)" style="cursor: pointer">
														...
														<div class="visible-xs visible-sm hidden-md hidden-lg">
															<div class="inline position-relative">
																...
																<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																	<li>
																		<a class="tooltip-info iframe" data-rel="tooltip" title="编辑" value="/scxfx_gk/user/edit_role/id/<?php echo $val['id']; ?>" cate="1">
																		<span class="blue">
																	...
																	<li>
																		<a onclick="del(<?php echo $val['id']; ?>)" class="tooltip-error" data-rel="tooltip" title="删除">
																		<span class="red">
							...
							<div class="col-xs-11" style="position: relative">
								...
								<div style="float: left">
									<button class="btn btn-sm btn-info iframe" value="/scxfx_gk/user/add_role" cate="2">
	...
	<script type="text/javascript">
                ...
                $('.del').click(function(){
                    ...
                    if(idArr != ''){
                        layer.confirm('你确定对所选对象进行删除操作?', {icon: 3, title:'删除'}, function(){
                            $.post('/scxfx_gk/user/role_del_batch',{idArr:idArr},function(data){
                                if(data.state == 1){
                                    layer.msg(data.info, {
                                        icon: 1,
            ...
            function del(id){
                layer.confirm('你确定删除?', {icon: 3, title:'删除'}, function(){
                    $.post('/scxfx_gk/user/role_del',{id:id},function(data){
                        if(data.state == 1){
                            layer.msg(data.info, {
                                icon: 1,
                                time: 2000, //2秒关闭（如果不配置，默认是3秒）
