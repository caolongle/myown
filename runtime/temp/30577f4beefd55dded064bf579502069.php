<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"E:\phpstudy\PHPTutorial\WWW\crm_gk\public/../application/scxfx_gk\view\public\success.html";i:1504510229;}*/ ?>
...
<div class="system-message">
    ...
    <script>
        swal({
            ...
            type: "success",
            html: true,
            text: '<h3><?php echo(strip_tags($msg)); ?></h3><br /><span><span id="wait"><?php echo($wait); ?></span>秒之后自动跳转</span>',
